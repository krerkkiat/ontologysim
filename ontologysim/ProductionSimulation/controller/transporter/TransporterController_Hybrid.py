                ...
                if len_erg > 0:
                    ...
                    for erg in erg_dict[k]:
                        ...
                        if product_onto_name in product_dict.keys():
                            product_dict[product_onto_name] += (
                        ...
                        if (
                            product_onto_name
                            in queue_dict_value[v.queue_selection].keys()
                        ):
                            queue_dict_value[v.queue_selection][product_onto_name] += (
                                value * self.controller_parameter_dict[k]
                            )
                        else:
                            queue_dict_value[v.queue_selection][product_onto_name] = (
                            ...
                            product_dict_value[v.queue_selection][product_onto_name] = (
                                erg
                            )
